      ...
      <div className="max-w-5xl mx-auto px-6 pt-32 pb-20">
        ...
        <header className="mb-32" id="about">
          ...
          <div className="flex flex-wrap gap-8 text-sm text-gray-600">
            ...
            <a href="mailto:ajas.muhammed1@gmail.com" className="hover:text-gray-900 transition-colors">
              Reach me: Email ↗
            </a>
            <a href="https://www.instagram.com/muhammed_ajas" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 transition-colors">
              Follow me: Instagram ↗
            </a>
          </div>
        </header>
        ...
        <section className="mb-32">
          <h2 className="text-sm font-semibold tracking-wider text-gray-400 mb-16">CAREER JOURNEY</h2>
            ...
            <div className="space-y-12">
              ...
              <div className="relative grid md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right">
                  <div className="inline-block px-4 py-2 bg-gray-900 text-white text-sm font-medium mb-4">
                    2022 — PRESENT
                  </div>
                  <h3 className="text-2xl font-light mb-2">Senior Site Reliability Engineer</h3>
                  <p className="text-gray-600">IBM India · Cognos Analytics on Cloud</p>
                </div>
                <div className="md:pl-8">
                  <div className="absolute left-0 md:left-1/2 w-4 h-4 bg-gray-900 rounded-full transform -translate-x-1/2 md:translate-x-0"></div>
                  <p className="text-gray-600 leading-relaxed">
                    Leading reliability engineering for Kubernetes infrastructure across 300+ clusters and 500+ customers.
                  </p>
                </div>
              </div>
              ...
              <div className="relative grid md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right md:order-1">
                  <div className="inline-block px-4 py-2 bg-gray-700 text-white text-sm font-medium mb-4">
                    2019 — 2022
                  </div>
                  <h3 className="text-2xl font-light mb-2">Cloud Architect / SRE</h3>
                  <p className="text-gray-600">TCS · Pfizer · Uruguay</p>
                </div>
                <div className="md:pr-8 md:text-right md:order-0">
                  <div className="absolute left-0 md:left-1/2 w-4 h-4 bg-gray-700 rounded-full transform -translate-x-1/2 md:translate-x-0"></div>
                  <p className="text-gray-600 leading-relaxed">
                    Cloud architecture, infrastructure modernization, and AWS migration with zero downtime.
                  </p>
                </div>
              </div>
              ...
              <div className="relative grid md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right">
                  <div className="inline-block px-4 py-2 bg-gray-500 text-white text-sm font-medium mb-4">
                    2017 — 2019
                  </div>
                  <h3 className="text-2xl font-light mb-2">Cloud Engineer</h3>
                  <p className="text-gray-600">TCS · Pfizer · India</p>
                </div>
                <div className="md:pl-8">
                  <div className="absolute left-0 md:left-1/2 w-4 h-4 bg-gray-500 rounded-full transform -translate-x-1/2 md:translate-x-0"></div>
                  <p className="text-gray-600 leading-relaxed">
                    Hybrid cloud operations, infrastructure maintenance, and CloudWatch monitoring.
                  </p>
                </div>
              </div>
              ...
              <div className="relative grid md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right md:order-1">
                  <div className="inline-block px-4 py-2 bg-gray-400 text-white text-sm font-medium mb-4">
                    2016 — 2017
                  </div>
                  <h3 className="text-2xl font-light mb-2">System Engineer</h3>
                  <p className="text-gray-600">TCS · Gartner · India</p>
                </div>
                <div className="md:pr-8 md:text-right md:order-0">
                  <div className="absolute left-0 md:left-1/2 w-4 h-4 bg-gray-400 rounded-full transform -translate-x-1/2 md:translate-x-0"></div>
                  <p className="text-gray-600 leading-relaxed">
                    Infrastructure operations, incident management, and customer support using ITIL practices.
                  </p>
                </div>
              </div>
            </div>
